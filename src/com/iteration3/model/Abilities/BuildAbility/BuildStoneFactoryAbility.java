...
public class BuildStoneFactoryAbility extends Ability {
    public BuildStoneFactoryAbility(Transporter transporter, ExecutionManager executionManager){
        super(transporter, GameLibrary.BUILD_STONEFACTORY_ABILITY, executionManager);
    }
