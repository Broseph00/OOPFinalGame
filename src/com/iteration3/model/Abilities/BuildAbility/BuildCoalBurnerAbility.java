...
public class BuildCoalBurnerAbility extends Ability {
    ...
    public BuildCoalBurnerAbility(Transporter transporter, ExecutionManager executionManager){
        super(transporter, GameLibrary.BUILD_COALBURNER_ABILITY, executionManager);
    }
