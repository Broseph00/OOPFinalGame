...
public class MoveDegree90Ability extends MoveAbility {
    ...
    public MoveDegree90Ability(Transporter transporter, ExecutionManager executionManager){
        super(transporter, 2,3, GameLibrary.MOVE_ANGLE90_ABILITY, executionManager);
    }
