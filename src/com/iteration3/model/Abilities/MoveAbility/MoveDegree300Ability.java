...
public class MoveDegree300Ability extends MoveAbility {
    ...
    public MoveDegree300Ability(Transporter transporter, ExecutionManager executionManager){
        super(transporter, 6,6, GameLibrary.MOVE_ANGLE300_ABILITY, executionManager);
    }
