...
public abstract class ConstructRoadAbility extends Ability {
    private int border;

    public ConstructRoadAbility(Transporter transporter, ExecutionManager executionManager, String name, int border){
