...
public class ProduceSteamerAbility extends ProductionAbility {

    public ProduceSteamerAbility(Transporter transporter, ExecutionManager executionManager){
        super(transporter, executionManager, GameLibrary.PRODUCE_STEAMER);
    }
