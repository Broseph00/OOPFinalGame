...
public class ProduceBoardAbility extends ProductionAbility {
    ...
    public ProduceBoardAbility(Woodcutter woodcutter, Transporter transporter, ExecutionManager executionManager){
        super(woodcutter, transporter, executionManager, GameLibrary.PRODUCE_BOARD);
    }
